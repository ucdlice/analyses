k2=read.table('all_lice_cleaned.2.Q')
k3=read.table('all_lice_cleaned.3.Q')
k4=read.table('all_lice_cleaned.4.Q')
k5=read.table('all_lice_cleaned.5.Q')
k6=read.table('all_lice_cleaned.6.Q')
k7=read.table('all_lice_cleaned.7.Q')
k8=read.table('all_lice_cleaned.8.Q')
k9=read.table('all_lice_cleaned.9.Q')
k10=read.table('all_lice_cleaned.10.Q')
k11=read.table('all_lice_cleaned.11.Q')
k12=read.table('all_lice_cleaned.12.Q')
k13=read.table('all_lice_cleaned.13.Q')
k14=read.table('all_lice_cleaned.14.Q')
k15=read.table('all_lice_cleaned.15.Q')

ad=read.table('../lice_info.txt', header=T, sep='\t', stringsAsFactor=F)
ids=read.table('all_lice_cleaned.fam')
ids$EID=ids$V1
